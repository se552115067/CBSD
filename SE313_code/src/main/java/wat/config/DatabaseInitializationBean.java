...
public class DatabaseInitializationBean implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        historyRepository.save(Arrays.asList(initHistory));
        ...
        Activity[] initActivity =  {
                ...
                new Activity(2l,"บายศรีสู่ขวัญ","บายศรีสู่ขวัญ กุฏิพระหอคำแปง สีหฬารามสามิกวัดพระสิงห์หลวง","th", ImageUtil.getImage("pic/2.JPG")),
                new Activity(3l,"บายศรีสู่ขวัญ","บายศรีสู่ขวัญ กุฏิพระหอคำแปง สีหฬารามสามิกวัดพระสิงห์หลวง","th", ImageUtil.getImage("pic/3.JPG")),
                new Activity(4l,"บายศรีสู่ขวัญ","บายศรีสู่ขวัญ กุฏิพระหอคำแปง สีหฬารามสามิกวัดพระสิงห์หลวง","th", ImageUtil.getImage("pic/1.JPG"))
        };
