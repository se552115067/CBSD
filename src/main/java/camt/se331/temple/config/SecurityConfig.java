...
import camt.se331.temple.config.security.AuthenticationTokenProcessingFilter;
import camt.se331.temple.config.security.CustomUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                  ...
                  //  .antMatchers("/qa/**").access("hasRole('user')")
                .and()
